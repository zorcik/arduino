...
#define UP_TIME 30000
#define DOWN_TIME 30000
...
void setup() {
    ...
    upButton.attach(UP_BUTTON, INPUT);
    upButton.interval(25);
    downButton.attach(DOWN_BUTTON, INPUT);
...
const int sensorPinUP = 4;
const int sensorPinDOWN = 5;
